...

{
  ...
  description: "When we build projects, we want to make them online. Instead of buying a domain and hosting, then taking the time to configure it. Moreover, the cost of domain and hosting is not cheap, so it's easier just to host it using GitHub Pages.",
  category:"React",
  time: "03:09 PM",
  date: "06/10/2021",
  ...
  filepath: "blog/content/2021/20210610030900-deploy-a-routed-react-app-to-github-pages.js",
}
...
export default class page_20210610030900 extends Component {
  render() {
    return (
      <div className="page">
        <PageNav />
        <div className="pageContainer">
          ...
          <div className="pageContent">
            ...
            <h2>How to Deploy Your Project to GitHub</h2>
            <q>
